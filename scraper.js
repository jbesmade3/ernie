        ...
        let intervCount = setInterval(async ()=>{
            ...
            getCounter.innerText = `Currently Getting: ${countM + 1} of ${trackArr.length}   Working on: ${trackArr[countM]}`
                ...
                port.onMessage.addListener(async (e)=>{
                    ...
                    let shipDate = rawDatas.actions[0].returnValue.returnValue.possessionFullDate || rawDatas.actions[0].returnValue.returnValue.mailingSfDate
                    ...
                    let estimatedDelivery = rawDatas.actions[0].returnValue.returnValue.expectedDeliveryFullDate || "Label Created"
